...
export default function Payment() {
  ...
  // Lấy giá vé an toàn
  const price = guestUserTicket?.[0]?.price ?? ticket?.[0]?.price ?? 0
  ...
  return (
    <>
      {loading ? (
        <div>quá trình tải dữ liệu đang diễn ra, vui lòng chờ...</div>
      ) : (
                          ...
                          >
                            {option.id === 1 && (
                              <>
                                ...
                                <span className='bg-green-500 font-medium text-[#fff] px-1 py-0.5 ml-1 rounded'>
                                  Pay
                                </span>
                              </>
                            )}
